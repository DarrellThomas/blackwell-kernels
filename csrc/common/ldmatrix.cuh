...
// Load 4 matrices with a1/a2 swap baked into operand order.
// ldmatrix outputs: r0=m0k0, r1=m0k1, r2=m1k0, r3=m1k1
// MMA expects:      a0=m0k0, a1=m1k0, a2=m0k1, a3=m1k1
// By using {%0, %2, %1, %3} the outputs land directly in MMA order,
// eliminating the need for separate MOV instructions.
