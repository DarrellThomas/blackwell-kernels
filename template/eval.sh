...
case "$KERNEL" in
    # example)
    #     TEST_SCRIPT="tests/test_example.py"
    #     BENCH_SCRIPT="benchmarks/bench_example.py"
    #     PROFILE_SCRIPT="profiles/profile_example.py"
    #     NCU_KERNEL_NAME="example_kernel"
    #     ;;
    *)
        echo "Unknown kernel: $KERNEL"
        echo "Available kernels: (add your kernels to eval.sh)"
        exit 1
        ;;
esac
