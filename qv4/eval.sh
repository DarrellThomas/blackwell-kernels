...
case "$KERNEL" in
    qv4)
        TEST_SCRIPT="tests/test_qv4.py"
        BENCH_SCRIPT="benchmarks/bench_qv4.py"
        PROFILE_SCRIPT="profiles/profile_qv4.py"
        NCU_KERNEL_NAME="qv4_simulate_kernel"
        ;;
    *)
        echo "Unknown kernel: $KERNEL"
        echo "Available kernels: qv4"
        exit 1
        ;;
esac
